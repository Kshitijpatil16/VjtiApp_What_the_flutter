        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children: [
                Text('Vjti', style: Theme.of(context).textTheme.headline5),
                Text('Teachers', style: Theme.of(context).textTheme.headline5),
                Text('App', style: Theme.of(context).textTheme.headline5),
              ],
            ),
            Image.asset(
